                ...
                <div class="products">
                    ...
                    <c:forEach var="item" items="${listProduct}">
                        ...
                        <div class="col-md-3 md-col">
                            <div class="col-md">
                                <a href="${pageContext.request.contextPath}/product/${item.productName}/${item.productId}.html" class="compare-in"><img  src="${pageContext.request.contextPath}/resources/pages/images/pic.jpg" alt="" />
                                    <div class="compare">
